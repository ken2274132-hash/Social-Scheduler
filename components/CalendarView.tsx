...
import { ChevronLeft, ChevronRight, Clock, CheckCircle, AlertCircle, XCircle } from 'lucide-react'
            ...
            <div className="grid grid-cols-7 gap-2">
                ...
                {Array.from({ length: daysInMonth }).map((_, i) => {
                    ...
                    return (
                        <div
                            key={day}
                            className={`aspect-square border border-gray-200 dark:border-gray-800 rounded-lg p-2 ${isToday ? 'bg-blue-50 dark:bg-blue-900/20 border-blue-500' : ''
                                }`}
                        >
                            ...
                            <div className="space-y-1">
                                {dayPosts.slice(0, 2).map(post => (
                                    <div
                                        key={post.id}
                                        className="flex items-center gap-1 text-xs text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 rounded px-1 py-0.5"
                                        title={post.caption}
                                    >
                                ...
                                {dayPosts.length > 2 && (
                                    <div className="text-xs text-gray-500 dark:text-gray-500 pl-1">
