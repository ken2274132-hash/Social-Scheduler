...
export default function ConnectInstagramButton({ workspaceId }: { workspaceId: string }) {
    ...
    return (
        <button
            ...
            disabled={loading}
            className="w-full sm:w-auto justify-center flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all font-medium disabled:opacity-50"
        >
            <Instagram size={20} />
